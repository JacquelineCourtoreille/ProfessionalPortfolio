...
-- CREATE TABLES --
	...
	(
		...
		phoneNumber VARCHAR(16) NOT NULL CHECK(phoneNumber ~ '^\+[1-9][0-9]{7,14}$'),
		createdAt TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
		updatedAt TIMESTAMPTZ NULL DEFAULT CURRENT_TIMESTAMP,
		deletedAt TIMESTAMPTZ NULL,
	...
	(
		...
		country CHAR(2) NULL,
		isDefaultShipping BOOLEAN NULL DEFAULT FALSE,
		isDefaultBilling BOOLEAN NULL DEFAULT FALSE,
		createdAt TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
		updatedAt TIMESTAMPTZ NULL DEFAULT CURRENT_TIMESTAMP,
		deletedAt TIMESTAMPTZ NULL,
	...
	(
		...
		CONSTRAINT fk_productmedia_product
			...
			ON DELETE CASCADE,
		CONSTRAINT uq_productmedia_product_displayorder
